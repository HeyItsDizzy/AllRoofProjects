  ...
  const handleSubmit = async () => {
    try {
      ...
      if (userData.logo instanceof File) {
        ...
        formData.append("avatar", userData.logo);
        ...
        try {
          ...
          if (data?.success && data?.url) {
            ...
            throw new Error(data?.message || "Avatar upload response missing expected fields.");
          }
        } catch (err) {
          return Swal.fire({
            icon: "error",
            title: "Upload Failed",
            text: err?.response?.data?.message || err.message || "Unexpected avatar upload error.",
          });
        }
      }
    ...
    <div className="min-h-screen bg-bgGray">
      <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-6">
          <h1 className="text-2xl font-bold text-textBlack">Company Profile</h1>
          <button
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div>
  <label className="block mb-1 text-textGray">Company Name</label>
  <input
    type="text"
    name="companyName"
...
<div>
  ...
  />
            ...
            <div className="md:col-span-2">
              <label className="block mb-1 text-textGray">Business Address</label>
              <AddressInput
