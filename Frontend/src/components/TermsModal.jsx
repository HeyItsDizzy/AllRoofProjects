...
const TermsModal = ({ visible, onClose }) => (
  ...
  >
    <div className="text-gray-700 leading-6 space-y-4">
      ...
      <Title level={5}>1. Service Use</Title>
      ...
      <Title level={5}>2. Take-Off Accuracy</Title>
      <ul className="list-disc list-inside">
      ...
      <Title level={5}>3. File Uploads and Content</Title>
      <ul className="list-disc list-inside">
      ...
      <Title level={5}>4. Payment and Invoicing</Title>
      <ul className="list-disc list-inside">
      ...
      <Title level={5}>5. Cancellation & Refund Policy</Title>
      <ul className="list-disc list-inside">
      ...
      <Title level={5}>6. Intellectual Property</Title>
      <ul className="list-disc list-inside">
      ...
      <Title level={5}>7. Liability Disclaimer</Title>
      <ul className="list-disc list-inside">
      ...
      <Title level={5}>8. Account and Data Security</Title>
      <ul className="list-disc list-inside">
      ...
      <Title level={5}>9. Amendments</Title>
      <Paragraph>
      ...
      <Title level={5}>10. Contact</Title>
      <Paragraph>
