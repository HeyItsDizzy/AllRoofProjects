...
const useAxiosFile = () => {
  ...
  // Use FILE_API_BASE_URL for file operations, fallback to regular API_BASE_URL
  const fileApiBaseUrl = import.meta.env.VITE_FILE_API_BASE_URL || import.meta.env.VITE_API_BASE_URL;
