...
export default function JobTable({
  ...
  // Add copy functionality to keyboard listener
  useEffect(() => {
    const handleKeyDown = (e) => {
      if ((e.ctrlKey || e.metaKey) && e.key === 'c' && cellSelectionMode) {
        handleCopy(e);
      }
    };
                  ...
                  {row.getVisibleCells().map((cell, colIndex) => {
                    ...
                    return (
                      <td
                        ...
                        onMouseDown={(e) => cellSelectionMode && handleCellMouseDown(e, rowIndex, colIndex)}
                        onMouseEnter={() => cellSelectionMode && handleCellMouseEnter(rowIndex, colIndex)}
                      >
