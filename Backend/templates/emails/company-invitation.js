...
const companyInvitation = (data) => {
  ...
  // Determine which logo to use in header - company logo from backend uploads
  ...
  // Footer logo - using a simple text-based logo for now until frontend is deployed
  const footerLogoUrl = `https://ui-avatars.com/api/?name=All+Roof+Takeoffs&background=081F13&color=fff&size=120&format=png`;
                    ...
                    <tr>
                      <td align="center" style="padding-bottom: 20px;">
                        <img src="${headerLogoUrl}" 
                             alt="${company} Logo" 
                             style="height: 60px; width: auto; max-width: 200px; display: block;">
                      </td>
                    </tr>
                    <tr>
                      <td align="center">
                    ...
                    <tr>
                      <td align="center" style="padding-bottom: 15px;">
                        <img src="${footerLogoUrl}" 
                             ...
                             style="height: 40px; width: auto; opacity: 0.8; display: block;">
                      </td>
                    </tr>
                    <tr>
                      <td align="center">
