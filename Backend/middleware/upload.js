...
const PDF_MAX_MB = 50;          // Max size for PDFs (reduced from 100MB)
const FILE_MAX_MB = 50;         // Max size for all other files (reduced from 100MB)
...
const avatarStorage = multer.diskStorage({
  destination: function (req, file, cb) {
    const uploadDir = "uploads/avatars/users/";
