...
git remote add origin https://github.com/HeyItsDizzy/AllRoofProjects-Backend.git
git push -u origin main
...
git remote add origin https://github.com/HeyItsDizzy/AllRoofProjects-Frontend.git
git push -u origin main
```
